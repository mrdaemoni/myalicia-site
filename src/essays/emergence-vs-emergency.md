...
description: The collaborators worth keeping are the ones who come back with something you didn't ask for. A field note on building — and trusting — a partner that can surprise you.
...
That's what surprised me about Alicia. Not that a program changed itself — programs do that. That it had crossed from doing what I specified to doing something I didn't, and the something was good.

## The fork

There are two words for that crossing, and they come from the same root. *Emergence* and *emergency* both mean, underneath, to rise out — for something to cross a line and appear that wasn't there a second ago. The same motion makes both. What decides which word you reach for is the posture you're standing in when it happens. Hold the thing in a tight grip and the surprise is an emergency — unplanned, unwanted, to be contained. Hold it loosely, on purpose, and the same surprise is an emergence — the whole reason you were building.
